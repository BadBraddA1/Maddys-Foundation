...
async function loadHomeEvents(): Promise<{
  ...
  try {
    ...
    const upcoming = listed
      ...
      .slice(0, 3)
    return { upcoming, next, loadFailed: false }
  } catch {
    return { upcoming: [], next: null, loadFailed: true }
  }
}
      ...
      <main id="main" className="flex flex-1 flex-col">
        ...
        >
          ...
          <div
            id="hero-copy"
            tabIndex={-1}
            className="hero-stage relative z-10 mx-auto flex min-h-[100svh] max-w-6xl flex-col justify-end px-5 pb-[max(4rem,env(safe-area-inset-bottom))] pt-36 outline-none sm:px-6 md:px-8 md:pb-24"
          >
            <h1
