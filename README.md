...
- Open Graph: AI cutout of Maddy on white (`public/brand/maddy-og-cutout.png`), green tent, logo/name on the left (no URL); events use `/events/[slug]/opengraph-image` (cover when set, else same cutout)
