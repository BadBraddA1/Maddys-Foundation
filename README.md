...
- Home hero header: clip-path animates in over the photo; after scrolling past `[data-home-hero]`, a frosted glass sticky bar appears (`HeroHeaderChrome` motion=`glass`)
