...
- Open Graph: photo (Maddy shifted right) + even fairway-green tent + centered logo/name type (no URL on the image); each event has `/events/[slug]/opengraph-image` (title/details, cover when set)
