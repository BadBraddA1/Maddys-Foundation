...
- Open Graph: static `app/opengraph-image.jpg` + `twitter-image.jpg` (1200×630, same layout with fairway-green tent) + `opengraph-image.alt.txt`; per-event ImageResponse at `/events/[slug]/opengraph-image`
